              ...
              <ul className="ml-3 mt-1">
                <li className="mt-1">
                  ...
                  <a
                    ...
                    href="https://forms.gle/x87o7F1ZAqdZKfiQ6"
                    target="_blank"
                    rel="noreferrer"
                  >
                    https://forms.gle/x87o7F1ZAqdZKfiQ6
                  </a>
            ...
            <li className="bold mt-2">
              ...
              <ul className="ml-3 mt-1">
                ...
                <li className="mt-1">
                  ...
                  INR 1,500/- or USD 50 is to be paid (each).
                </li>
                <li className="mt-1">
          ...
          <ol className="ml-4 mt-2">
            ...
            <li className="bold mb-1">
              ...
              <div className="ml-3 mt-1 answer">
                ...
                <a className="paperSubmissionLink" href="mailto:e2a@ei.nits.ac.in">
                  e2a@ei.nits.ac.in
                </a>{" "}
