        ...
        <div className="members">
          ...
          <ul className="ml-3">
            <li className="member mt-3">
              <p>Dr. Anup Kumar Sharma</p>
              <p className="mt-1">Assistant Professor, Department of E&I Engineering, NIT Silchar</p>
              <p className="mt-1">Phone: +91-9672505707 </p>
            ...
            <li className="member mt-4">
              <p>Dr. Pravin PS</p>
              <p className="mt-1">Assistant Professor, Department of E&I Engineering, NIT Silchar</p>
              <p className="mt-1">Phone: +91-7506112294 </p>
              {/* <p className="mt-1">Email: <a href="mailto:seban@ei.nits.ac.in" rel="noreferrer">seban@ei.nits.ac.in</a></p> */}
            </li>
            <li className="member mt-4">
              <p className="mt-1">Email: <a href="mailto:e2a@ei.nits.ac.in" rel="noreferrer">e2a@ei.nits.ac.in</a></p>
            </li>
          </ul>
        </div>
