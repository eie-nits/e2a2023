      ...
      <section id="about" className="container home-page bg-white">
        <div className="about">
          ...
          <div className="home-about-content">
            <p className="text1 mb-1">
              Emerging Electronics and Automation (E2A) 2023 is the 3
              <sup>rd</sup> annual International Conference organized by the
              Department of Electronics and Instrumentation Engineering at NIT
              Silchar, Assam. E2A 2023 is scheduled to be in hybrid mode between
              15th and 17th December 2023.
            </p>
            <p className="text1">
              We are happy to share that till now, Department of EIE has
              successfully orgainised two editions of E2A. The proceedings of
              the First Edition is indexed in{" "}
              <a
            ...
            <div className="mtb-4 book-list">
              ...
              <div className="ml-4">
                ...
                >
                  Select Proceedings of E2A 2021
                </p>
                ...
                <p className="mt-2">
                  ...
                  Automation (E2A) 2021. The book presents new ideas, research
            ...
            <p className="text1">
              ...
              AI and soft computing. Tracing the path of the 2nd Edition, E2A
              2023 will pave a common platform for the academicians,
          ...
          <p className="text1 red">
            ...
            </a>. Select papers from the conference will be published by Springer
            ...
            be published. Springer Nature does not charge any money for
            publication of Non-Open Access content. Abstracts/extended abstracts
            and short papers (less than 4 pages) are not considered for
            publication.
          </p>
        </div>
        ...
        <div className="datetime">
          ...
          <div className="mb-3">
            ...
            <p>
              15<sup>th</sup> - 17<sup>th</sup> December 2023
            </p>
          </div>
          <div className="mb-3">
            <div className="mb-1">
