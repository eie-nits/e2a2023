    ...
    <section id="about" className="container home-page bg-white">
        <div className="about">
          ...
          <div className="home-about-content">
            ...
            <p className="text1">This conference focuses on trending research and product outcomes in the domain of control and robotics, signal processing, communication systems, sensors and instrumentation, MEMS and VLSI, AI and soft computing. Tracing the path of the 2nd Edition, E2A 2023 will pave a common platform for the academicians, researchers, industrial players and budding research scholars to discuss their results, innovations, challenges encountered during research and concerns with peers and update their knowledge by interacting with leading researchers of respective domains. It offers a great opportunity for them to network together, present research progress and addresses new challenges. This conference promises to provide knowledge enriching keynote lectures to the participants by world-renowned researchers in the relevant thematic areas.</p>
          </div>
        ...
        <div className="datetime">
          ...
          <div className="mb-3">
            ...
            <p>15<sup>th</sup> - 17<sup>th</sup> December 2023</p>
          </div>
          <div className="mb-3">
            <div className="mb-1">
          ...
          <div className="mb-3">
            ...
            <p>
              <a style={{color: "#127CCC"}} className="e2a-link" target="__blank" href="http://e2a2022.nits.ac.in">E2A2022</a><br/>
